...
$(function() {
  ...
  $('.visible-desktop #messages, .visible-desktop #notifications').click(function(e){
    ...
    $('.top-menu #notifications').popover({
      ...
      placement: 'bottom',
      title: 'Notifications',
      content:'<ul><li><a href="#"><img src="assets/img/avatars/07.jpg"><span>Today</span><h4>欢迎入驻本行</h4>EDUTokensKeep欢迎您！</a></li><li><a href="#"><img src="assets/img/avatars/09.jpg"><span>Yesterday</span><h4>Customer Support</h4>You have 3 new tickets assigned to you.</a></li></ul><div class="popover_footer"><a href="">View all notifications</a></div>'
    });
